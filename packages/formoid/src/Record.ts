...
export function map<T extends UnknownRecord, B>(record: T, f: (a: T[keyof T], key: keyof T) => B): Record<keyof T, B> {
...
export function forEach<T extends UnknownRecord>(record: T, f: (a: T[keyof T], key: keyof T) => void) {
